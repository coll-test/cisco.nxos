...
from ansible_collections.cisco.nxos.plugins.module_utils.network.nxos.config.telemetry.telemetry import Telemetry
...
import pytest
from ansible_collections.cisco.nxos.plugins.module_utils.network.nxos.nxos import nxosCmdRef_import_check
...
class TestNxosTelemetryModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_FACT_LEGACY_SUBSETS = patch('ansible_collections.cisco.nxos.plugins.module_utils.network.nxos.facts.facts.FACT_LEGACY_SUBSETS')
        ...
        self.mock_edit_config = patch('ansible_collections.cisco.nxos.plugins.module_utils.network.nxos.config.telemetry.telemetry.Telemetry.edit_config')
