...
class TestNxosVpcModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.cisco.nxos.plugins.modules.nxos_vpc.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.cisco.nxos.plugins.modules.nxos_vpc.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_run_commands = patch('ansible_collections.cisco.nxos.plugins.modules.nxos_vpc.run_commands')
