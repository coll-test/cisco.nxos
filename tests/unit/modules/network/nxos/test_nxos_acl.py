...
class TestNxosAclModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.cisco.nxos.plugins.modules.nxos_acl.run_commands')
        self.run_commands = self.mock_run_commands.start()

        self.mock_load_config = patch('ansible_collections.cisco.nxos.plugins.modules.nxos_acl.load_config')
