...
class TestNxosSystemModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.cisco.nxos.plugins.modules.nxos_system.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.cisco.nxos.plugins.modules.nxos_system.load_config')
