...
from ansible_collections.cisco.nxos.plugins.module_utils.network.nxos.nxos import run_commands, get_config, get_capabilities
from ansible_collections.cisco.nxos.plugins.module_utils.network.nxos.utils.utils import get_interface_type, normalize_interface
